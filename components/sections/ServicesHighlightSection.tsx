...
const ServiceCard: React.FC<ServiceCardProps> = ({ icon, title, description }) => (
  <div className="bg-gradient-to-br from-slate-800 to-slate-900 p-10 rounded-xl text-center transition-all duration-500 ease-in-out shadow-xl group hover:shadow-2xl hover:shadow-red-600/20 hover:-translate-y-2 hover:scale-[1.03] h-full flex flex-col items-center border border-slate-800">
    <div className="text-red-500 mb-6 mx-auto w-20 h-20 flex items-center justify-center bg-slate-900 rounded-full transition-all duration-300 group-hover:bg-red-500 group-hover:text-white group-hover:scale-110 flex-shrink-0 shadow-inner">{icon}</div>
